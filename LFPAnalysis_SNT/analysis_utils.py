...
def select_rois_picks(elec_data, chan_name, manual_col='collapsed_manual', file_path=''):
    ...
    if file_path == '':
        file_path = pkg_resources.resource_filename('LFPAnalysis_SNT', 'YBA_ROI_labelled.xlsx')
    # file_path = 'YBA_ROI_labelled.xlsx'
    # print(file_path)
